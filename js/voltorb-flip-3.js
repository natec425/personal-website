...
var _user$project$Game_Core$subscriptions = function (board) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Game_Core$colAvailableSpaces = F2(
	function (board, col) {
...
var _user$project$Game_Core$rowAvailableSpaces = F2(
	function (board, row) {
		return _elm_lang$core$List$length(
			A2(
				_elm_lang$core$List$filter,
...
var _user$project$Game_Core$exposedColPoints = F2(
	function (board, col) {
...
var _user$project$Game_Core$exposedRowPoints = F2(
	function (board, row) {
		return _elm_lang$core$List$sum(
			A2(
				_elm_lang$core$List$map,
...
var _user$project$Game_Core$cellValue = F3(
...
var _user$project$Game_Core$score = function (board) {
...
var _user$project$Game_Core$rowMines = F2(
	function (board, row) {
...
var _user$project$Game_Core$rowPoints = F2(
	function (board, row) {
		return _elm_lang$core$List$sum(
			A2(
				_elm_lang$core$List$map,
...
var _user$project$Game_Core$rowAvailablePoints = F2(
	function (board, row) {
		return A2(_user$project$Game_Core$rowPoints, board, row) - A2(_user$project$Game_Core$exposedRowPoints, board, row);
	});
var _user$project$Game_Core$colMines = F2(
	function (board, col) {
		return _elm_lang$core$Set$size(
			A2(
				_elm_lang$core$Set$filter,
...
var _user$project$Game_Core$colPoints = F2(
	function (board, col) {
		return _elm_lang$core$List$sum(
			A2(
				_elm_lang$core$List$map,
...
var _user$project$Game_Core$colAvailablePoints = F2(
	function (board, col) {
		return A2(_user$project$Game_Core$colPoints, board, col) - A2(_user$project$Game_Core$exposedColPoints, board, col);
	});
var _user$project$Game_Core$allTargetsExposed = function (board) {
...
var _user$project$Game_Core$hasExposedMine = function (board) {
	return _elm_lang$core$Basics$not(
		_elm_lang$core$Set$isEmpty(
			A2(_elm_lang$core$Set$intersect, board.exposed, board.mines)));
};
var _user$project$Game_Core$emptyBoard = {mines: _elm_lang$core$Set$empty, exposed: _elm_lang$core$Set$empty, targets: _elm_lang$core$Dict$empty};
var _user$project$Game_Core$allPoss = _elm_lang$core$Set$fromList(
	_elm_lang$core$Native_List.fromArray(
		[
...
var _user$project$Game_Core$size = 5;
var _user$project$Game_Core$randomSample = F2(
	function (n, l) {
		return A2(
			_elm_lang$core$Random$map,
...
var _user$project$Game_Core$randomPoss = F2(
	function (n, availablePoss) {
		return A2(
			...
			A2(
				_user$project$Game_Core$randomSample,
				n,
				_elm_lang$core$Array$fromList(
					_elm_lang$core$Set$toList(availablePoss))));
	});
var _user$project$Game_Core$populateRandomMines = F2(
	function (n, b) {
		return A2(
			_elm_lang$core$Random$map,
			function (ms) {
			...
			A2(_user$project$Game_Core$randomPoss, n, _user$project$Game_Core$allPoss));
	});
var _user$project$Game_Core$listZip = F2(
	function (a, b) {
		return A3(
			_elm_lang$core$List$map2,
			F2(
				function (l, r) {
					return {ctor: '_Tuple2', _0: l, _1: r};
				}),
			a,
			b);
	});
var _user$project$Game_Core$populateRandomTargets = F2(
	function (n, b) {
		var targetPoints = A2(
			_elm_lang$core$Random$list,
			n,
			A2(_elm_lang$core$Random$int, 2, 3));
		var availablePoss = A2(_elm_lang$core$Set$diff, _user$project$Game_Core$allPoss, b.mines);
		var targetPoss = A2(
			_elm_lang$core$Random$map,
			_elm_lang$core$Set$toList,
			A2(_user$project$Game_Core$randomPoss, n, availablePoss));
		var targets = A3(
			_elm_lang$core$Random$map2,
			F2(
				function (poss, points) {
					return _elm_lang$core$Dict$fromList(
						A2(_user$project$Game_Core$listZip, poss, points));
				}),
			targetPoss,
			targetPoints);
		return A2(
...
var _user$project$Game_Core$randomBoard = function (level) {
	var numTargets = 5 + level;
	var numMines = ((25 - numTargets) / 2) | 0;
	return A2(
		_elm_lang$core$Random$andThen,
		A2(
			_elm_lang$core$Random$andThen,
			_elm_community$random_extra$Random_Extra$constant(_user$project$Game_Core$emptyBoard),
			_user$project$Game_Core$populateRandomMines(numMines)),
		_user$project$Game_Core$populateRandomTargets(numTargets));
};
var _user$project$Game_Core$Board = F3(
	function (a, b, c) {
		return {mines: a, exposed: b, targets: c};
	});
var _user$project$Game_Core$Lost = function (a) {
	return {ctor: 'Lost', _0: a};
};
var _user$project$Game_Core$Won = function (a) {
	return {ctor: 'Won', _0: a};
};
var _user$project$Game_Core$Playing = function (a) {
	return {ctor: 'Playing', _0: a};
};
var _user$project$Game_Core$exposePlaying = F3(
	function (board, row, column) {
		...
		return _user$project$Game_Core$hasExposedMine(board$) ? _user$project$Game_Core$Lost(board$) : (_user$project$Game_Core$allTargetsExposed(board$) ? _user$project$Game_Core$Won(board$) : _user$project$Game_Core$Playing(board$));
	});
var _user$project$Game_Core$NoGame = {ctor: 'NoGame'};
var _user$project$Game_Core$expose = F3(
	function (model, row, column) {
		var _p6 = model;
		switch (_p6.ctor) {
			case 'NoGame':
				return _user$project$Game_Core$NoGame;
			case 'Playing':
				return A3(_user$project$Game_Core$exposePlaying, _p6._0, row, column);
			case 'Won':
				return _user$project$Game_Core$Won(_p6._0);
			default:
				return _user$project$Game_Core$Lost(_p6._0);
		}
	});
var _user$project$Game_Core$NewGame = {ctor: 'NewGame'};
var _user$project$Game_Core$Expose = F2(
	function (a, b) {
		return {ctor: 'Expose', _0: a, _1: b};
	});
var _user$project$Game_Core$NewBoard = function (a) {
	return {ctor: 'NewBoard', _0: a};
};
var _user$project$Game_Core$init = {
	ctor: '_Tuple2',
	_0: _user$project$Game_Core$NoGame,
	_1: A2(
		_elm_lang$core$Random$generate,
		_user$project$Game_Core$NewBoard,
		_user$project$Game_Core$randomBoard(1))
};
var _user$project$Game_Core$update = F2(
	function (msg, model) {
		var _p7 = msg;
		switch (_p7.ctor) {
			case 'NoOp':
			...
			case 'NewBoard':
				return {
					ctor: '_Tuple2',
					_0: _user$project$Game_Core$Playing(_p7._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Expose':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Game_Core$expose, model, _p7._0, _p7._1),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
...
var _user$project$Game_Core$NoOp = {ctor: 'NoOp'};

var _user$project$AI_Core$expectation = F2(
	function (board, _p0) {
		var _p1 = _p0;
		var _p3 = _p1._0;
		var _p2 = _p1._1;
		return A2(
			...
			A3(_user$project$Game_Core$cellValue, board, _p3, _p2)) : ((_elm_lang$core$Native_Utils.eq(
			_user$project$Game_Core$size - A2(_user$project$Game_Core$rowMines, board, _p3),
			0) || _elm_lang$core$Native_Utils.eq(
			_user$project$Game_Core$size - A2(_user$project$Game_Core$colMines, board, _p2),
			0)) ? 0.0 : A2(
			_elm_lang$core$Basics$min,
			_elm_lang$core$Basics$toFloat(
				A2(_user$project$Game_Core$rowAvailablePoints, board, _p3)) / _elm_lang$core$Basics$toFloat(
				A2(_user$project$Game_Core$rowAvailableSpaces, board, _p3)),
			_elm_lang$core$Basics$toFloat(
				A2(_user$project$Game_Core$colAvailablePoints, board, _p2)) / _elm_lang$core$Basics$toFloat(
				A2(_user$project$Game_Core$colAvailableSpaces, board, _p2))));
	});
var _user$project$AI_Core$action = function (board) {
	var response = A2(
		_elm_community$list_extra$List_Extra$maximumBy,
		_user$project$AI_Core$expectation(board),
		_elm_lang$core$Set$toList(
			A2(_elm_lang$core$Set$diff, _user$project$Game_Core$allPoss, board.exposed)));
	var _p4 = response;
	if (_p4.ctor === 'Just') {
		return _p4._0;
	} else {
...
var _user$project$AI_Core$play = function (board) {
	var _p6 = _user$project$AI_Core$action(board);
	var row = _p6._0;
	var column = _p6._1;
	return A2(
		_user$project$Game_Core$update,
		A2(_user$project$Game_Core$Expose, row, column),
		_user$project$Game_Core$Playing(board));
};
var _user$project$AI_Core$Model = F5(
	function (a, b, c, d, e) {
		return {wins: a, losses: b, points: c, gameModel: d, playing: e};
	});
var _user$project$AI_Core$GameMsg = function (a) {
	return {ctor: 'GameMsg', _0: a};
};
var _user$project$AI_Core$init = function () {
	var _p7 = _user$project$Game_Core$init;
	var gameModel = _p7._0;
	var gameCmd = _p7._1;
	return {
		ctor: '_Tuple2',
		_0: {wins: 0, losses: 0, points: 0, gameModel: gameModel, playing: false},
		_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$AI_Core$GameMsg, gameCmd)
	};
}();
var _user$project$AI_Core$update = F2(
	function (msg, model) {
		update:
		while (true) {
			var _p8 = {ctor: '_Tuple2', _0: msg, _1: model.gameModel};
			switch (_p8._0.ctor) {
				case 'Play':
					switch (_p8._1.ctor) {
						case 'Playing':
							var _p9 = _user$project$AI_Core$play(_p8._1._0);
							var gameModel = _p9._0;
							var gameCmd = _p9._1;
							return {
								ctor: '_Tuple2',
						...
						case 'NoGame':
							var _v3 = _user$project$AI_Core$GameMsg(_user$project$Game_Core$NewGame),
								_v4 = model;
							msg = _v3;
							model = _v4;
							continue update;
						case 'Won':
							var _v5 = _user$project$AI_Core$GameMsg(_user$project$Game_Core$NewGame),
								_v6 = _elm_lang$core$Native_Utils.update(
								model,
								{
									wins: model.wins + 1,
									points: model.points + _user$project$Game_Core$score(_p8._1._0)
								});
							msg = _v5;
							model = _v6;
							continue update;
						default:
							var _v7 = _user$project$AI_Core$GameMsg(_user$project$Game_Core$NewGame),
				...
				case 'GameMsg':
					var _p10 = A2(_user$project$Game_Core$update, _p8._0._0, model.gameModel);
					var gameModel = _p10._0;
					var gameCmd = _p10._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
...
var _user$project$AI_Core$AutoPlay = {ctor: 'AutoPlay'};
var _user$project$AI_Core$Play = {ctor: 'Play'};
var _user$project$AI_Core$subscriptions = function (model) {
	return model.playing ? _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Game_Core$subscriptions(model.gameModel),
				A2(
				_elm_lang$core$Time$every,
				5 * _elm_lang$core$Time$millisecond,
				function (_p11) {
					return _user$project$AI_Core$Play;
				})
			])) : _user$project$Game_Core$subscriptions(model.gameModel);
};

var _user$project$Game_View$mineStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'color', _1: 'red'}
		]));
var _user$project$Game_View$pointStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'color', _1: 'green'},
			{ctor: '_Tuple2', _0: 'display', _1: 'block'}
		]));
var _user$project$Game_View$colSummaryStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
...
var _user$project$Game_View$colSummariesStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[]));
var _user$project$Game_View$rowSummaryStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'display', _1: 'block'},
			{ctor: '_Tuple2', _0: 'background', _1: '#DDDDDD'},
...
var _user$project$Game_View$rowSummariesStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'margin', _1: '0px'}
		]));
var _user$project$Game_View$cellStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'padding', _1: '.5em'},
...
var _user$project$Game_View$minefieldStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'float', _1: 'left'}
		]));
var _user$project$Game_View$borderCollapse = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'border-collapse', _1: 'collapse'}
		]));
var _user$project$Game_View$baseStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
...
var _user$project$Game_View$restartButton = A2(
	_elm_lang$html$Html$button,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Events$onClick(_user$project$Game_Core$NewGame)
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html$text('Click to Restart')
		]));
var _user$project$Game_View$viewColSummary = F2(
	function (board, col) {
		return A2(
			_elm_lang$html$Html$td,
			_elm_lang$core$Native_List.fromArray(
				[_user$project$Game_View$colSummaryStyle]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					_elm_lang$html$Html$span,
					_elm_lang$core$Native_List.fromArray(
						[_user$project$Game_View$pointStyle]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(
								A2(_user$project$Game_Core$colPoints, board, col)))
						])),
					A2(
					_elm_lang$html$Html$span,
					_elm_lang$core$Native_List.fromArray(
						[_user$project$Game_View$mineStyle]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(
								A2(_user$project$Game_Core$colMines, board, col)))
						]))
				]));
	});
var _user$project$Game_View$viewColSummaries = function (board) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[_user$project$Game_View$colSummariesStyle]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_elm_lang$html$Html$table,
				_elm_lang$core$Native_List.fromArray(
					[_user$project$Game_View$borderCollapse]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Array$toList(
							A2(
								_elm_lang$core$Array$initialize,
								_user$project$Game_Core$size,
								_user$project$Game_View$viewColSummary(board))))
					]))
			]));
};
var _user$project$Game_View$viewRowSummary = F2(
	function (board, row) {
		return A2(
			_elm_lang$html$Html$td,
			_elm_lang$core$Native_List.fromArray(
				[_user$project$Game_View$rowSummaryStyle]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					_elm_lang$html$Html$span,
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(
								A2(_user$project$Game_Core$rowPoints, board, row)))
						])),
					A2(
					_elm_lang$html$Html$span,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(
								A2(_user$project$Game_Core$rowMines, board, row)))
						]))
				]));
	});
var _user$project$Game_View$viewRowSummaries = function (board) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[_user$project$Game_View$rowSummariesStyle]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_elm_lang$html$Html$table,
					...
					[
						...
						_elm_lang$core$Array$toList(
							A2(
								_elm_lang$core$Array$initialize,
								_user$project$Game_Core$size,
								_user$project$Game_View$viewRowSummary(board))))
					]))
			]));
};
var _user$project$Game_View$viewCell = F3(
	function (board, row, column) {
		return A2(
			_elm_lang$html$Html$td,
			_elm_lang$core$Native_List.fromArray(
				[
					_user$project$Game_View$cellStyle,
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					if (A2(
						...
						{ctor: '_Tuple2', _0: row, _1: column},
						board.exposed)) {
						var v = A3(_user$project$Game_Core$cellValue, board, row, column);
...
var _user$project$Game_View$viewRow = F2(
	function (board, row) {
		return A2(
			_elm_lang$html$Html$tr,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Array$toList(
				A2(
					_elm_lang$core$Array$initialize,
					_user$project$Game_Core$size,
					A2(_user$project$Game_View$viewCell, board, row))));
	});
var _user$project$Game_View$viewMineField = function (board) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[_user$project$Game_View$minefieldStyle]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_elm_lang$html$Html$table,
				...
				_elm_lang$core$Array$toList(
					A2(
						_elm_lang$core$Array$initialize,
						_user$project$Game_Core$size,
						_user$project$Game_View$viewRow(board))))
			]));
};
var _user$project$Game_View$viewScore = function (board) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					...
					'Your Score: ',
					_elm_lang$core$Basics$toString(
						_user$project$Game_Core$score(board))))
			]));
};
var _user$project$Game_View$link = F2(
	function (atts, children) {
		return A3(_elm_lang$html$Html$node, 'link', atts, children);
	});
var _user$project$Game_View$viewBoard = function (board) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[_user$project$Game_View$baseStyle]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_user$project$Game_View$link,
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Game_View$viewMineField(board),
						_user$project$Game_View$viewRowSummaries(board)
					])),
				_user$project$Game_View$viewColSummaries(board),
				_user$project$Game_View$restartButton
			]));
};
var _user$project$Game_View$view = function (model) {
	var _p0 = model;
	switch (_p0.ctor) {
		case 'NoGame':
			return _user$project$Game_View$restartButton;
		case 'Playing':
			var _p1 = _p0._0;
			return A2(
				_elm_lang$html$Html$div,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							...
							'Your Score: ',
							_elm_lang$core$Basics$toString(
								_user$project$Game_Core$score(_p1)))),
						_user$project$Game_View$viewBoard(_p1)
					]));
		case 'Won':
			return A2(
				_elm_lang$html$Html$div,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$Game_View$viewBoard(
						_elm_lang$core$Native_Utils.update(
							_p0._0,
							{exposed: _user$project$Game_Core$allPoss}))
					]));
		default:
			return A2(
				_elm_lang$html$Html$div,
...
var _user$project$AI_View$autoPlayButton = function (model) {
	return A2(
		_elm_lang$html$Html$button,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Events$onClick(_user$project$AI_Core$AutoPlay)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$AI_View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$AI_Core$GameMsg,
				_user$project$Game_View$view(model.gameModel)),
				_user$project$AI_View$autoPlayButton(model),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[]),
...
var _user$project$AI_Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$AI_Core$init, view: _user$project$AI_View$view, update: _user$project$AI_Core$update, subscriptions: _user$project$AI_Core$subscriptions})
};

var Elm = {};
Elm['AI'] = Elm['AI'] || {};
Elm['AI']['Main'] = Elm['AI']['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['AI']['Main'], 'AI.Main', typeof _user$project$AI_Main$main === 'undefined' ? null : _user$project$AI_Main$main);
