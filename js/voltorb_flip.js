...
var _user$project$Game$expose = F3(
...
var _user$project$Game$mineStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'color', _1: 'red'}
		]));
var _user$project$Game$pointStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'color', _1: 'green'},
			{ctor: '_Tuple2', _0: 'display', _1: 'block'}
		]));
var _user$project$Game$colSummaryStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
...
var _user$project$Game$colSummariesStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[]));
var _user$project$Game$rowSummaryStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'display', _1: 'block'},
			{ctor: '_Tuple2', _0: 'background', _1: '#DDDDDD'},
...
var _user$project$Game$rowSummariesStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'margin', _1: '0px'}
		]));
var _user$project$Game$cellStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'padding', _1: '.5em'},
...
var _user$project$Game$minefieldStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'float', _1: 'left'}
		]));
var _user$project$Game$borderCollapse = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'border-collapse', _1: 'collapse'}
		]));
var _user$project$Game$baseStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'font-family', _1: '\'Roboto\', sans-serif'},
			{ctor: '_Tuple2', _0: 'width', _1: '50%'},
			{ctor: '_Tuple2', _0: 'margin', _1: '0 25% 0 25%'},
...
var _user$project$Game$colMines = F2(
	function (model, col) {
		return _elm_lang$core$Set$size(
			A2(
				...
				function (_p0) {
					var _p1 = _p0;
					return _elm_lang$core$Native_Utils.eq(col, _p1._1);
				},
				model.mines));
	});
var _user$project$Game$colPoints = F2(
	function (model, col) {
...
var _user$project$Game$viewColSummary = F2(
	function (model, col) {
		return A2(
			_elm_lang$html$Html$td,
			_elm_lang$core$Native_List.fromArray(
				[_user$project$Game$colSummaryStyle]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					_elm_lang$html$Html$span,
					_elm_lang$core$Native_List.fromArray(
						[_user$project$Game$pointStyle]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(
								A2(_user$project$Game$colPoints, model, col)))
						])),
					A2(
					_elm_lang$html$Html$span,
					_elm_lang$core$Native_List.fromArray(
						[_user$project$Game$mineStyle]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(
								A2(_user$project$Game$colMines, model, col)))
						]))
				]));
	});
var _user$project$Game$rowMines = F2(
	function (model, row) {
		return _elm_lang$core$Set$size(
			A2(
				_elm_lang$core$Set$filter,
				function (_p2) {
					var _p3 = _p2;
					return _elm_lang$core$Native_Utils.eq(_p3._0, row);
				},
				model.mines));
	});
var _user$project$Game$rowPoints = F2(
	function (model, row) {
		return _elm_lang$core$List$sum(
			A2(
				_elm_lang$core$List$map,
...
var _user$project$Game$viewRowSummary = F2(
	function (model, row) {
		return A2(
			_elm_lang$html$Html$td,
			_elm_lang$core$Native_List.fromArray(
				[_user$project$Game$rowSummaryStyle]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					_elm_lang$html$Html$span,
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(
								A2(_user$project$Game$rowPoints, model, row)))
						])),
					A2(
					_elm_lang$html$Html$span,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(
								A2(_user$project$Game$rowMines, model, row)))
						]))
				]));
	});
var _user$project$Game$cellValue = F3(
	function (model, row, column) {
		if (A2(
			_elm_lang$core$Set$member,
			{ctor: '_Tuple2', _0: row, _1: column},
...
var _user$project$Game$score = function (model) {
	return _elm_lang$core$Set$isEmpty(model.exposed) ? 0 : _elm_lang$core$List$product(
		A2(
			_elm_lang$core$List$map,
			function (p) {
				return A2(
					...
					1,
					A2(_elm_lang$core$Dict$get, p, model.targets));
			},
			_elm_lang$core$Set$toList(model.exposed)));
};
var _user$project$Game$viewScore = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					...
					'Your Score: ',
					_elm_lang$core$Basics$toString(
						_user$project$Game$score(model))))
			]));
};
var _user$project$Game$viewWin = function (model) {
	return A2(
		_elm_lang$html$Html$span,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Set$isEmpty(
					A2(_elm_lang$core$Set$intersect, model.exposed, model.mines))) ? _elm_lang$html$Html$text('You Lose!') : (_elm_lang$core$Set$isEmpty(
				A2(
					_elm_lang$core$Set$diff,
					_elm_lang$core$Set$fromList(
						_elm_lang$core$Dict$keys(model.targets)),
					model.exposed)) ? A2(
				_elm_lang$html$Html$span,
				_elm_lang$core$Native_List.fromArray(
					[]),
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Game$viewScore(model),
						_elm_lang$html$Html$text('You Win!')
					])) : _user$project$Game$viewScore(model))
			]));
};
var _user$project$Game$allPoss = _elm_lang$core$Set$fromList(
	_elm_lang$core$Native_List.fromArray(
		[
...
var _user$project$Game$size = 5;
var _user$project$Game$randomPos = A2(
	_elm_lang$core$Random$pair,
	A2(_elm_lang$core$Random$int, 0, _user$project$Game$size - 1),
	A2(_elm_lang$core$Random$int, 0, _user$project$Game$size - 1));
var _user$project$Game$viewRowSummaries = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[_user$project$Game$rowSummariesStyle]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_elm_lang$html$Html$table,
				_elm_lang$core$Native_List.fromArray(
					[_user$project$Game$borderCollapse]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Array$toList(
							A2(
								_elm_lang$core$Array$initialize,
								_user$project$Game$size,
								_user$project$Game$viewRowSummary(model))))
					]))
			]));
};
var _user$project$Game$viewColSummaries = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[_user$project$Game$colSummariesStyle]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_elm_lang$html$Html$table,
					...
					[
						...
						_elm_lang$core$Array$toList(
							A2(
								_elm_lang$core$Array$initialize,
								_user$project$Game$size,
								_user$project$Game$viewColSummary(model))))
					]))
			]));
};
var _user$project$Game$link = F2(
	function (atts, children) {
		return A3(_elm_lang$html$Html$node, 'link', atts, children);
	});
var _user$project$Game$randomSample = F2(
	function (n, l) {
		return A2(
			_elm_lang$core$Random$map,
...
var _user$project$Game$randomPoss = F2(
	function (n, availablePoss) {
		return A2(
			...
			A2(
				_user$project$Game$randomSample,
				n,
				_elm_lang$core$Array$fromList(
					_elm_lang$core$Set$toList(availablePoss))));
	});
var _user$project$Game$randomMines = _user$project$Game$randomPoss;
var _user$project$Game$randomConst = function (a) {
	return A2(
		_elm_lang$core$Random$map,
		function (_p6) {
			return a;
...
var _user$project$Game$listZip = F2(
	function (a, b) {
		return A3(
			_elm_lang$core$List$map2,
			F2(
...
var _user$project$Game$randomTargets = F2(
	function (n, availablePoss) {
		var rpoints = A2(
		...
		var rposs = A2(
			...
			A2(_user$project$Game$randomPoss, n, availablePoss));
		return A3(
			_elm_lang$core$Random$map2,
			F2(
				function (poss, points) {
					return _elm_lang$core$Dict$fromList(
						A2(_user$project$Game$listZip, poss, points));
				}),
			rposs,
			rpoints);
	});
var _user$project$Game$randomGame = function (level) {
	var numTargets = 5 + level;
	var numMines = ((25 - numTargets) / 2) | 0;
	var rMines = A2(_user$project$Game$randomPoss, numMines, _user$project$Game$allPoss);
	var rTargetPoss = A2(
		_elm_lang$core$Random$map,
		_elm_lang$core$Set$diff(_user$project$Game$allPoss),
		rMines);
	var rTargets = A2(
		_elm_lang$core$Random$andThen,
		rTargetPoss,
		_user$project$Game$randomTargets(numTargets));
	return A3(
		_elm_lang$core$Random$map2,
		F2(
			function (ms, ts) {
				return {mines: ms, targets: ts, exposed: _elm_lang$core$Set$empty};
			}),
		rMines,
		rTargets);
};
var _user$project$Game$genTargets = function (l) {
	return A2(
		_elm_lang$core$Random$map,
		_elm_lang$core$Dict$fromList,
		A3(
			_elm_lang$core$Random$map2,
			_user$project$Game$listZip,
			_user$project$Game$randomConst(l),
			A2(
				_elm_lang$core$Random$list,
				_elm_lang$core$List$length(l),
				A2(_elm_lang$core$Random$int, 2, 3))));
};
var _user$project$Game$listHalves = function (l) {
	var len = _elm_lang$core$Basics$round(
		_elm_lang$core$Basics$toFloat(
			_elm_lang$core$List$length(l)) / 2);
	return {
		ctor: '_Tuple2',
		_0: A2(_elm_lang$core$List$take, len, l),
		_1: A2(_elm_lang$core$List$drop, len, l)
	};
};
var _user$project$Game$genGame = A2(
	_elm_lang$core$Random$map,
	function (_p7) {
		var _p8 = _p7;
		return {mines: _p8._0, targets: _p8._1, exposed: _elm_lang$core$Set$empty};
	},
	A2(
		_elm_lang$core$Random$andThen,
		A2(
			...
			function (_p9) {
				...
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Set$fromList(_p10._0),
					_1: _p10._1
				};
			},
			A2(
				_elm_lang$core$Random$map,
				function (_p11) {
					return _user$project$Game$listHalves(
						_elm_lang$core$Set$toList(
							_elm_lang$core$Set$fromList(_p11)));
				},
				A2(_elm_lang$core$Random$list, 25, _user$project$Game$randomPos))),
		function (_p12) {
			var _p13 = _p12;
			return A2(
				_elm_lang$core$Random$pair,
				_user$project$Game$randomConst(_p13._0),
				_user$project$Game$genTargets(_p13._1));
		}));
var _user$project$Game$arraySwap = F3(
	function (a, i, j) {
		return A2(
			...
			A2(
				...
				function (aj) {
					return A3(_elm_lang$core$Array$set, i, aj, a);
				},
				A2(_elm_lang$core$Array$get, j, a)),
			function (a$) {
				return A2(
					_elm_lang$core$Maybe$map,
					function (ai) {
						return A3(_elm_lang$core$Array$set, j, ai, a$);
					},
					A2(_elm_lang$core$Array$get, i, a));
			});
	});
...
var _user$project$Game$NewGame = {ctor: 'NewGame'};
var _user$project$Game$restartButton = A2(
	_elm_lang$html$Html$button,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Events$onClick(_user$project$Game$NewGame)
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html$text('Click to Restart')
		]));
var _user$project$Game$Expose = F2(
	function (a, b) {
		return {ctor: 'Expose', _0: a, _1: b};
	});
var _user$project$Game$viewCell = F3(
	function (model, row, column) {
		return A2(
			_elm_lang$html$Html$td,
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(_user$project$Game$Expose, row, column))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					_elm_lang$core$Set$member,
					{ctor: '_Tuple2', _0: row, _1: column},
					model.exposed) ? _elm_lang$html$Html$text(
					A3(_user$project$Game$cellValue, model, row, column)) : _elm_lang$html$Html$text('?')
				]));
	});
var _user$project$Game$viewRow = F2(
	function (model, row) {
		return A2(
			_elm_lang$html$Html$tr,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Array$toList(
				A2(
					_elm_lang$core$Array$initialize,
					_user$project$Game$size,
					A2(_user$project$Game$viewCell, model, row))));
	});
var _user$project$Game$viewMineField = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[_user$project$Game$minefieldStyle]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_elm_lang$html$Html$table,
				...
				_elm_lang$core$Array$toList(
					A2(
						_elm_lang$core$Array$initialize,
						_user$project$Game$size,
						_user$project$Game$viewRow(model))))
			]));
};
var _user$project$Game$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[_user$project$Game$baseStyle]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_user$project$Game$link,
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[])),
				_user$project$Game$viewWin(model),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[]),
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Game$viewMineField(model),
						_user$project$Game$viewRowSummaries(model)
					])),
				_user$project$Game$viewColSummaries(model),
				_user$project$Game$restartButton
			]));
};
var _user$project$Game$InitGame = function (a) {
	return {ctor: 'InitGame', _0: a};
};
var _user$project$Game$init = {
	ctor: '_Tuple2',
	_0: {mines: _elm_lang$core$Set$empty, exposed: _elm_lang$core$Set$empty, targets: _elm_lang$core$Dict$empty},
	_1: A2(
		_elm_lang$core$Random$generate,
		_user$project$Game$InitGame,
		_user$project$Game$randomGame(1))
};
var _user$project$Game$update = F2(
	function (msg, model) {
		...
		switch (_p14.ctor) {
			...
			case 'InitGame':
				return {ctor: '_Tuple2', _0: _p14._0, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Expose':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Game$expose, model, _p14._0, _p14._1),
